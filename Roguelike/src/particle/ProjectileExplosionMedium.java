...
public class ProjectileExplosionMedium extends Particle {
	...
	public static void loadTextures() {
		...
		ProjectileExplosionMedium.sprites.put(Particle.RED, GraphicsTools.loadAnimation("/projectile_explosion_medium_red.png", 32, 32));
		ProjectileExplosionMedium.sprites.put(Particle.YELLOW, GraphicsTools.loadAnimation("/projectile_explosion_medium_yellow.png", 32, 32));
	}
